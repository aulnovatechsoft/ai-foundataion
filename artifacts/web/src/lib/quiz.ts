...
import proofPersonImg from "@/assets/onboarding/proof-person.png";
import nextLevelImg from "@/assets/onboarding/next-level.png";
...
// the outcome on the reveal and paywall (e.g. "…so you can get your promotion").
